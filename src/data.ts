...
export const cookingMoods: CookingMood[] = [
  { id: "nourish", emoji: "🌿", label: "Nourish", tagline: "I want to feed my body well",
    ...
    aiSignal: "Prioritise nutritionally dense meals, lean proteins, lots of vegetables, whole grains, and flavour through herbs and spices rather than fat or sugar." },
  ...
  { id: "tired", emoji: "😮‍💨", label: "Tired", tagline: "I have almost no energy for this",
    ...
    aiSignal: "Suggest 5-ingredient max recipes, one-pan meals, no-cook options, toast-based meals, eggs, leftovers transformation. Never suggest anything complex." },
  { id: "stressed", emoji: "🌀", label: "Stressed", tagline: "My mind is full — food needs to be simple or therapeutic",
    ...
    aiSignal: "Either very fast low-decision meals, OR simple repetitive-process cooking (bread, pasta from scratch, stir-fry) that is meditative without being technically demanding." },
  { id: "sad", emoji: "🌧️", label: "Low / Sad", tagline: "I need food that holds me gently",
    ...
    aiSignal: "Soft, warm, unchallenging food. Think soup, porridge, congee, simple pasta, scrambled eggs, warm toast with good toppings. Never suggest difficult recipes." },
  ...
  { id: "focused", emoji: "💪", label: "Performance / Focused", tagline: "Food is fuel right now",
    ...
    aiSignal: "Prioritise high-protein, complex-carb meals. Include macro estimates. Suggest meal-prep friendly options. Nothing that causes energy crashes." },
];
